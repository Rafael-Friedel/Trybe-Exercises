...
const tacaro = (produto) => produto.some((objeto) => objeto.price > 300)

// console.log(tacaro(techProducts))

const qualpreco = (produto, idd, quantidade) => produto.find((object) => object.id === idd).price * quantidade
      

// console.log(qualpreco(techProducts, 1, 2));
